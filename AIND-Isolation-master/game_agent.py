...
def custom_score(game, player):
    ...
    """ I have fiddled about with the values and their multiplicators
        ...
        even though it is very much slower it still performs better
        - 7% off the overall runtime compared to 3% for the individual ones -
        ...
        My conclusions were:
            ...
            my best attempt is still "number legal moves" 
...
#    @jit(nopython=True, parallel=True)
    ...
    #def max_value(self, gameState, depth, alpha, beta):
        ...
        #
        #for m in legal:
        #    min_branch, min_branch_move = self.min_value(gameState.forecast_move(m), depth - 1, alpha, beta)
        #    if min_branch > v:
        #        v = min_branch
        #        move_for_v = m
        #
    ...
    #def min_value(self, gameState, depth, alpha, beta):
        ...
        #
        #for m in legal:
        #    max_branch, max_branch_move = self.max_value(gameState.forecast_move(m), depth - 1, alpha, beta)
        #
        #    if max_branch < v:
        #        v = max_branch
        #        move_for_v = m
